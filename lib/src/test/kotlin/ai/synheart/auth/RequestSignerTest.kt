...
class RequestSignerTest {
    ...
    fun `canonical message format`() {
        val msg = RequestSigner.buildMessage("POST", "/v1/data", "1767225600", null)
        val expected = "POST\n/v1/data\n1767225600\n"
    ...
    fun `canonical message with body`() {
        ...
        val msg = RequestSigner.buildMessage("POST", "/v1/data", "1767225600", body)
        val expected = "POST\n/v1/data\n1767225600\n{\"key\":\"value\"}"
        assertEquals(expected, String(msg, Charsets.UTF_8))
    }
    ...
    fun `method is uppercased`() {
        val msg = RequestSigner.buildMessage("get", "/v1/data", "1767225600", null)
