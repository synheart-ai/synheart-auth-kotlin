...
Thank you for taking the time to look at Synheart Auth (Kotlin). This document explains
...
1. Search [existing issues](https://github.com/synheart-ai/synheart-auth-kotlin/issues) to avoid
   duplicates.
